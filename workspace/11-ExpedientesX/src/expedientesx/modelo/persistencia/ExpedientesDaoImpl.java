...
public class ExpedientesDaoImpl implements ExpedientesDao, InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		guardar(new Expediente("El Niño Murciélago","En 2004, tenía cinco metros de altura y su peso era desconocido. Cambia sus alas cada tres años, y regenera un nuevo par.", "imagenes/batboy.jpg", "Mulder", true));
		guardar(new Expediente("Avistamiento Big Foot","Bigfoot se describe en los informes como una gran peluda criatura simiesca, que oscila entre 6-10 pies de altura  (3.2 m), con un peso de más de 500 libras (230 kg), y cubierto de pelo marrón rojizo oscuro u oscuro. ", "imagenes/bigfoot.jpg", "Scully", false));
		guardar(new Expediente("Elvis esta vivo","Se asegura que el cantante estadounidense de rock no habría muerto realmente en 1977, y que viviría de incógnito viajando por el mundo. ¿Dónde ha sido visto Elvis? En Montana, Cambridge, Southampton,...", "imagenes/elvis.jpg", "Mulder", false));
